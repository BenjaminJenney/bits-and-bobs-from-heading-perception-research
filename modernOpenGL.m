...
memsize = whos('vertices');
glBufferData(GL.ARRAY_BUFFER, memsize.bytes, vertices, GL.STATIC_DRAW);
...
fragShaderPath = 'C:\Users\benje\Desktop\openGLMatlab\moglDotsShaders\fragmentShader.frag';
